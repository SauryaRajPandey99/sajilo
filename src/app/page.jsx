...
//             Everything you need to manage your finances in one place. We make it
//             easy to track your spending, create budgets, and achieve your
//             financial goals.
//           </h2>
...
//               <Card
//                 key={index}
//                 className="p-6 hover:shadow-xl hover:-translate-y-2 hover:scale-105 transition-all duration-500 group"
//               >
...
export default function Home() {
  return (
    <div className="mt-40">
      ...
      {/* Stats Section - Modern gradient background with glassmorphism */}
